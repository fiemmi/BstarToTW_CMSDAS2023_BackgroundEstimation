...
dir=/afs/cern.ch/user/m/mmorris/BackgroundEstimation/CMSSW_10_6_14/src/BstarToTW_CMSDAS2023_BackgroundEstimation/regions
...
signames=`cat signames.txt`


# mkdir $savedir
# cp ../2018/ttbarfits_cen2b$tag/*root $dir/all/$savedir

for signame in $signames
do

    mkdir $dir/all/ttbarfits_inclusive/${signame}_area

    combineCards.py Name1=$dir/2016/ttbarfits_inclusive/${signame}_area/${signame}_card.txt Name2=$dir/2017/ttbarfits_inclusive/${signame}_area/${signame}_card.txt Name3=$dir/2018/ttbarfits_inclusive/${signame}_area/${signame}_card.txt > $dir/all/ttbarfits_inclusive/${signame}_area/${signame}_card.txt
    
    echo "combing cards into  $dir/all/ttbarfits_inclusive/${signame}_card.txt"
...
do
    ...
    cd $dir/all/$savedir/${signame}_area
    pwd
    combineTool.py -M AsymptoticLimits -d ${signame}_card.txt --saveWorkspace --cminDefaultMinimizerStrategy 0   -v 0 --job-mode condor --sub-opts='+JobFlavour="longlunch"'
    echo "combineTool.py -M AsymptoticLimits -d ${signame}_card.txt --saveWorkspace --cminDefaultMinimizerStrategy 0   -v 0 --job-mode condor --sub-opts='+JobFlavour="longlunch"'"

done

# Name1=$dir/2016/ttbarfits_inclusive/signalRSGluon1000_area/signalRSGluon1000_card.txt Name2=$dir/2017/ttbarfits_inclusive/signalRSGluon1000_area/signalRSGluon1000_card.txt Name3=$dir/2018/ttbarfits_inclusive/signalRSGluon1000_area/signalRSGluon1000_card.txt > $dir/all/signalRSGluon1000_area/signalRSGluon1000_card.txt
