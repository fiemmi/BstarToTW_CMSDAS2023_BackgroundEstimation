...
def FTest(regionby, poly1, poly2):
    '''
    ...
    '''
    area1 = 'ttbarfits_{}_{}'.format(regionby, poly1)
    area2 = 'ttbarfits_{}_{}'.format(regionby, poly2)
...
#     print('params1', params1)
    ...
    def plot_FTest(base_fstat,nRpfs1,nRpfs2,nBins):
        ...
        c.SaveAs('./ftest_{0}_vs_{1}_{2}.png'.format(poly1,poly2,regionby))
