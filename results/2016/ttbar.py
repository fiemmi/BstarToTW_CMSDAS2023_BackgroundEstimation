...
#     plot.plot_signalInjection(savedirname, 'signal{}_area'.format(signal), condor=condor)
    plot.plot_signalInjection(savedirname, 'ttbar-RSGluon2000_area', injectedAmount=injectedAmount, seed=123456, stats=True, condor=False)
...
#         GoF(sig, tf='', nToys=300, condor=False)	
#         plot_GoF(sig, tf='', condor=False)	

#         doSignalInjection(sig, tf='', nToys=100, injectedAmount=0.000, condor=False)	
        plot_signalinjection(sig, tf='', nToys=100, injectedAmount=0.000, condor=False)
        plot_signalinjection(sig, tf='', nToys=100, injectedAmount=1.000, condor=False)

    #     doSignalInjection(sig, tf='', nToys=100, injectedAmount=0.000, condor=False)	
    #     print 'plotting signal injection'
    #     plot_signalinjection(sig, tf='', nToys=100, injectedAmount=0.000, condor=False)
