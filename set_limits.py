...
dirs = {
        'cen0b': 'ttbarfits_cen0b_1x2',
        'fwd0b': 'ttbarfits_fwd0b_1x2',
        'cen1b': 'ttbarfits_cen1b_2x1',
        'fwd1b': 'ttbarfits_fwd1b_2x1',
        'cen2b': 'ttbarfits_cen2b_3x1',
        'fwd2b': 'ttbarfits_fwd2b_3x1',
...
for cat in cats:
    for signal in signals:
        ...
        if inclusive:
            ...
            directory = 'regions/' + year + '/' + dirs[cat]
        ...
        if inclusive:
            ...
            CMS_lumi.extraText = 'Preliminary' + ' ' + cat
        ...
        savefilename = 'limits/pdf/regions/limits_combine_' + signal + '_' + year + '_' + cat + '_blind.pdf'
